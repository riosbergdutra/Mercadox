...
public class EnderecoServiceImpl implements EnderecoService {
    ...
    public Optional<EnderecoDto> getEnderecoById(UUID id, UUID userId) {
        return enderecoRepository.findById(id)
                .filter(endereco -> endereco.getUsuario().getIdUsuario().equals(userId)) // Verifica a associação com o
                                                                                         // usuário
                .map(endereco -> new EnderecoDto(endereco.getRua(), endereco.getNumero(), endereco.getCidade(),
    ...
    public List<EnderecoDto> getAllEnderecos(UUID userId) {
        return enderecoRepository.findByUsuarioId(userId).stream() // Busca por ID do usuário
                .map(endereco -> new EnderecoDto(endereco.getRua(), endereco.getNumero(), endereco.getCidade(),
                        endereco.getEstado(), endereco.getCep()))
    ...
    public EnderecoDto updateEndereco(UUID id, EnderecoDto enderecoDto, UUID userId) {
        Endereco endereco = enderecoRepository.findById(id)
                .filter(e -> e.getUsuario().getIdUsuario().equals(userId)) // Verifica a associação com o usuário
        ...
        return new EnderecoDto(updatedEndereco.getRua(), updatedEndereco.getNumero(), updatedEndereco.getCidade(),
