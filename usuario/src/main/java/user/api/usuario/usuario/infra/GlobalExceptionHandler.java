 ...
 * 
 * Esta classe fornece manipuladores para exceções específicas e retorna respostas apropriadas para o cliente.
 */
@ControllerAdvice
public class GlobalExceptionHandler {
     ...
     * @return Resposta com status 500 (Internal Server Error) e mensagem de erro padrão.
     */
